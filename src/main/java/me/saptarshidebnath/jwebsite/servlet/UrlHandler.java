...
public class UrlHandler extends HttpServlet {
     ...
     *
     * @param request  Takes a reference of {@link javax.servlet.http.HttpServletRequest HttpServletRequest}
     *                 this is sent by the web server created from the http request sent by the HttpClient
     *                 [generally a browser like Chrome]
     * @param response Takes a reference {@link javax.servlet.http.HttpServletResponse}  which is going to be
     *                 populated and sent to the HttpClient [Generally a browser like Chrome]
     * @throws ServletException Throws {@link javax.servlet.ServletException ServletException} to report any Servlet Error
    ...
    public void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        response.getWriter().println("<h1>Default Servlet/h1>");
    }
