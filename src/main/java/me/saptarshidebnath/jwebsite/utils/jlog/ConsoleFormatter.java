 ...
 * me.saptarshidebnath.jwebsite.utils.jlog.JLog JLog} logger.
 */
public class ConsoleFormatter extends Formatter {
  /**
   * The Stack trace depth variable contains the depth of Stack trace to extract the calling method
   * and class name.
   */
  ...
  /**
   * Set the debug method for the {@link ConsoleFormatter}. As of now, it just prints the stacktrace
   * from where it retrieves the calling method and class name.
   *
   * @param debug This need to be of type @ boolean
   */
   ...
   *
   * @param depth Set the depth of the stack trace from where the content of the calling method is
   ...
   *
   * @param record Input {@link java.util.logging.LogRecord LogRecord}
  ...
  public String format(final LogRecord record) {
    ...
    final String exceptionMessage =
        exceptionThrown == null ? "" : " !! " + exceptionThrown.getLocalizedMessage();
    return "[ "
  ...
  /**
   * This method calls the @getStackTraceElementByDepth and computes the class name method name and
   * line number Currently the depth is statically set to 9
   *
   ...
   *
   * @param exception Takes {@link java.lang.Throwable Throwable } object as input.
  ...
  /**
   * Return the Stack Trace element by the depth. This is internally used by the Formatter to get
   * the calling method and calling class
   *
