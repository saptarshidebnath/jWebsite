...
public class JLog {
  ...
  /**
   The {@link Logger} object used currently only use
   {@link java.util.logging.ConsoleHandler ConsoleHandler} only.
   This method end point can be used to add extra handler as needed.

   @param handler
   Any object of {@link java.util.logging.Handler Handler} class or its sub class can be sent as
   a input Parameter.
   */
  ...
  /**
   Returns the current array of {@link java.util.logging.Handler Handler} for the current
  ...
  /**
   ...
   @param level
   The {@link java.util.logging.Level Level} is the level of the logging message.
   @param message
   The {@link java.lang.String String} object which is expected to contain the generic message.
   @param throwable
   The {@link java.lang.Throwable} object or any of its sub class in case a exception needs to be
   logged.
   */
  ...
  /**
   The generic overloaded {@link #log log} method to log WITHOUT
   {@link java.lang.Exception Exception} logging. The custom Logger is based upon
   {@link java.util.logging.Logger Logger}
  ...
  /**
   The log method for logging {@link java.lang.String String} messages with
   {@link java.util.logging.Level#INFO Level#INFO}
  ...
  /**
   ...
   @param message
   The {@link String} object which is expected to contain the generic message.
   @param throwable
   The {@link Throwable} object or any of its sub class in case a exception needs to be logged.
   */
