...
public class JLog {
   ...
   *
   * @param handler
   *     Any object of {@link java.util.logging.Handler Handler} class or its sub class
   ...
   * @param message
   *     The {@link java.lang.String String} object which is expected to contain the
   *     generic message.
   * @param throwable
   *     The {@link java.lang.Throwable} object or any of its sub class in case a
   ...
   *
   * @param message
   *     The {@link java.lang.String String} object which is expected to contain
   *     the generic message.
   */
   ...
   * @param throwable
   *     The {@link Throwable} object or any of its sub class in case a exception
   *     needs to be logged.
   */
