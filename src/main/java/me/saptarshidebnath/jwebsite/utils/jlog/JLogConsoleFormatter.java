...
public class JLogConsoleFormatter extends Formatter {
  ...
  /**
   * Set the debug method for the {@link JLogConsoleFormatter}. As of now, it just prints the
   ...
   *
   * @param depth
   *     Set the depth of the stack trace from where the content of the calling method is
  ...
  public String format(final LogRecord record) {
    ...
    final String exceptionMessage = exceptionThrown
                                    == null ? "" : " !! "
